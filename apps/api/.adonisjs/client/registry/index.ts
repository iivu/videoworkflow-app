...
const routes = {
  ...
  'video_workspaces.list': {
    ...
    tokens: [{"old":"/api/v1/video-workspaces","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces","type":0,"val":"video-workspaces","end":""}],
    types: placeholder as Registry['video_workspaces.list']['types'],
  },
  'video_workspaces.create': {
    methods: ["POST"],
    pattern: '/api/v1/video-workspaces',
    tokens: [{"old":"/api/v1/video-workspaces","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces","type":0,"val":"video-workspaces","end":""}],
    types: placeholder as Registry['video_workspaces.create']['types'],
  },
  'video_workspaces.show': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/video-workspaces/:id',
    tokens: [{"old":"/api/v1/video-workspaces/:id","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['video_workspaces.show']['types'],
  },
  'video_workspaces.rename': {
    methods: ["PUT"],
    pattern: '/api/v1/video-workspaces/:id',
    tokens: [{"old":"/api/v1/video-workspaces/:id","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['video_workspaces.rename']['types'],
  },
  'video_workspaces.save_canvas': {
    methods: ["PUT"],
    pattern: '/api/v1/video-workspaces/:id/canvas',
    tokens: [{"old":"/api/v1/video-workspaces/:id/canvas","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id/canvas","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id/canvas","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id/canvas","type":1,"val":"id","end":""},{"old":"/api/v1/video-workspaces/:id/canvas","type":0,"val":"canvas","end":""}],
    types: placeholder as Registry['video_workspaces.save_canvas']['types'],
  },
  'video_workspaces.remove': {
    methods: ["DELETE"],
    pattern: '/api/v1/video-workspaces/:id',
    tokens: [{"old":"/api/v1/video-workspaces/:id","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['video_workspaces.remove']['types'],
  },
  'video_workspaces.generate': {
    methods: ["POST"],
    pattern: '/api/v1/video-workspaces/:id/nodes/:nodeId/generate',
    tokens: [{"old":"/api/v1/video-workspaces/:id/nodes/:nodeId/generate","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id/nodes/:nodeId/generate","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id/nodes/:nodeId/generate","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id/nodes/:nodeId/generate","type":1,"val":"id","end":""},{"old":"/api/v1/video-workspaces/:id/nodes/:nodeId/generate","type":0,"val":"nodes","end":""},{"old":"/api/v1/video-workspaces/:id/nodes/:nodeId/generate","type":1,"val":"nodeId","end":""},{"old":"/api/v1/video-workspaces/:id/nodes/:nodeId/generate","type":0,"val":"generate","end":""}],
    types: placeholder as Registry['video_workspaces.generate']['types'],
  },
  'video_workspaces.list_tasks': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/video-workspaces/:id/tasks',
    tokens: [{"old":"/api/v1/video-workspaces/:id/tasks","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id/tasks","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id/tasks","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id/tasks","type":1,"val":"id","end":""},{"old":"/api/v1/video-workspaces/:id/tasks","type":0,"val":"tasks","end":""}],
    types: placeholder as Registry['video_workspaces.list_tasks']['types'],
  },
  'video_workspaces.show_task': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/video-workspaces/:id/tasks/:taskId',
    tokens: [{"old":"/api/v1/video-workspaces/:id/tasks/:taskId","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId","type":1,"val":"id","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId","type":0,"val":"tasks","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId","type":1,"val":"taskId","end":""}],
    types: placeholder as Registry['video_workspaces.show_task']['types'],
  },
  'video_workspaces.check_task': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/video-workspaces/:id/tasks/:taskId/check',
    tokens: [{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/check","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/check","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/check","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/check","type":1,"val":"id","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/check","type":0,"val":"tasks","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/check","type":1,"val":"taskId","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/check","type":0,"val":"check","end":""}],
    types: placeholder as Registry['video_workspaces.check_task']['types'],
  },
  'video_workspaces.abandon_task': {
    methods: ["POST"],
    pattern: '/api/v1/video-workspaces/:id/tasks/:taskId/abandon',
    tokens: [{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/abandon","type":0,"val":"api","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/abandon","type":0,"val":"v1","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/abandon","type":0,"val":"video-workspaces","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/abandon","type":1,"val":"id","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/abandon","type":0,"val":"tasks","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/abandon","type":1,"val":"taskId","end":""},{"old":"/api/v1/video-workspaces/:id/tasks/:taskId/abandon","type":0,"val":"abandon","end":""}],
    types: placeholder as Registry['video_workspaces.abandon_task']['types'],
  },
  'oss.upload': {
    methods: ["POST"],
