...
export default class extends BaseSchema {
  protected tableName = 'wanxiang_video_tasks';
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.index(['user_id', 'entity_id'], 'idx_wanxiang_video_tasks_user_entity');
      table.index(['status'], 'idx_wanxiang_video_tasks_status');
      table.index(['created_at'], 'idx_wanxiang_video_tasks_created_at');
    });
  }
