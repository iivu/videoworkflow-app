import { Button, Label, Select, SelectContent, SelectGroup, SelectItem, SelectTrigger, SelectValue, Slider, Switch } from '@r/ui';
...
function SwitchField(props: { id: string; label: string; description: string; checked: boolean; onChange: (checked: boolean) => void }) {
  return (
    <div className="flex items-center justify-between gap-3">
      <Label htmlFor={props.id} className="flex flex-col items-start gap-0.5">
        {props.label}
...
export function ConfigPanel({ provider, bailianConfigs, minimaxiConfigs, onBailianChange, onMinimaxiChange, onReset }: ConfigPanelProps) {
  if (!provider) {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-medium">合成参数</h3>
